        ...
        >
          <div className="container">
            <div className="section-1">
              <div className="row">
                <div className="col-md-6 p-3">
                  ...
                  <h1>ProBoxspring</h1>
                  <p>
                    Op zoek naar een nieuwe boxspring? Dan bent u bij ons aan
                    het juiste adres! Wij van ProBoxspring zitten al meer dan 30
                    jaar in het vak van slapen. Van slapen hebben wij ons werk
                    gemaakt. En om ons werk goed uit te kunnen voeren moeten wij
                    elke dag goed uitgerust en fit wakker worden. Dat doen wij
                    door op de beste bedden te slapen.
                  </p>
            ...
            <div className="section-5">
              ...
              <div className="d-flex mx-auto position-relative wrapper">
                <img
                  src="https://cdn.sanity.io/images/2v5nba1d/production/fddaf602d7ff151aad2a21a4597e807c41feb1be-1000x600.jpg"
                  alt=""
                  className="mx-auto position-relative rounded-md w-75"
                />
                <div className="position-absolute textwrapper d-flex">
                  <div>
                    <h6 className="fa-2x">Zeer tevreden en perfect</h6>
                    <p>
                      Een website kan verschillende doelstellingen hebben. Er
                      zijn websites die informeren, websites die bezoekers in
                    </p>
                  </div>
                </div>
              </div>
